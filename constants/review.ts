...
export const positiveLabel: { [key: string]: string } = {
    tasty: '맛있어요',
    good_view: '뷰맛집',
    spacious: '매장이 넓어요',
    ...
    good_value: '가성비좋은',
    anniversary: '기념일',
    good_for_parents: '부모님 모시고',
    dating_course: '데이트코스',
    good_for_family: '가족외식',
    gathering_place: '회식장소',
    good_for_solo: '혼밥',
    kid_friendly: '아이와 함께',
    clean: '청결해요',
    pet_friendly: '펫 친화',
...
export const FEEDBACK_LIST: FeedBackType[] = [
    {
        type: 'positive',
        items: [
            { id: 1, label: '맛있어요', value: 'tasty' },
            { id: 2, label: '뷰가 좋아요', value: 'good_view' },
            { id: 3, label: '매장이 넓어요', value: 'spacious' },
            { id: 4, label: '주차가 편해요', value: 'easy_parking' },
            { id: 5, label: '친절해요', value: 'friendly' },
            { id: 6, label: '가성비가 좋아요', value: 'good_value' },
            { id: 7, label: '기념일', value: 'anniversary' },
            { id: 8, label: '부모님 모시고 오기 좋아요', value: 'good_for_parents' },
            { id: 9, label: '데이트코스', value: 'dating_course' },
            { id: 10, label: '가족외식', value: 'good_for_family' },
            { id: 11, label: '회식장소', value: 'gathering_place' },
            { id: 12, label: '혼밥 가능', value: 'good_for_solo' },
            { id: 13, label: '아이와 함께 오기 좋아요', value: 'kid_friendly' },
            { id: 14, label: '청결해요', value: 'clean' },
            { id: 15, label: '반려동물과 함께 가능해요', value: 'pet_friendly' },
        ],
    },
    {
        type: 'negative',
        items: [
            { id: 16, label: '주차 공간이 협소해요', value: 'limited_parking' },
            { id: 17, label: '음식이 늦게 나와요', value: 'slow_service' },
            { id: 18, label: '양이 적어요', value: 'small_portions' },
            { id: 19, label: '불친절해요', value: 'unfriendly' },
            { id: 20, label: '웨이팅이 길어요', value: 'long_wait' },
            { id: 21, label: '시끄러워요', value: 'noisy' },
            { id: 22, label: '메뉴가 적어요', value: 'limited_menu' },
            { id: 23, label: '매장이 협소해요', value: 'small_space' },
            { id: 24, label: '혼밥하기 힘들어요', value: 'hard_for_solo' },
            { id: 25, label: '찾아가기 어려워요', value: 'hard_to_find' },
            { id: 26, label: '비싼 편이에요', value: 'expensive' },
        ],
    },
];
